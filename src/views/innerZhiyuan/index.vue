  ...
  <d2-container>
    <template slot="header">
      ...
      <el-row type="flex" align="middle">
        ...
        <el-col :span="2">
          <el-button type="primary" icon="el-icon-close" size="small" @click="closePage">关闭</el-button>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    async initPage (inputData) {
      ...
      const result = await api.KS_FILTER_CONSULT_LIST(JSON.stringify(data))
